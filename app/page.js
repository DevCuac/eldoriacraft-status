...
export default function MinecraftServer() {
  ...
  const fetchServerStatus = async () => {
    try {
      ...
      setServerStatus({
        ...
        description:
          data.motd?.clean?.[0] || "Bienvenido a nuestro servidor de Minecraft!",
      });
    } catch (error) {
  ...
  const copyIP = () => {
    ...
    toast({
      title: "IP del servidor copiada!",
      description: "La IP ha sido copiada a tu portapapeles.",
    });
  };
                ...
                <div className="flex items-center justify-between">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Actualizar el estado del servidor</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
            ...
            <Card className="border-zinc-800/50 bg-black/40 backdrop-blur-md transition-all hover:bg-black/50 minecraft-card">
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-3">
                  {[
                    {
                      title: "Experiencia de Supervivencia",
                      description:
                        "Juego de supervivencia puro vainilla con comandos esenciales.",
                      icon: "⚔️",
                    },
                    {
                      title: "Comunidad Activa",
                      description:
                        "Jugadores amigables y eventos comunitarios regulares",
                      icon: "🏰",
                    },
                    {
                      title: "Protección contra el Raideos",
                      description:
                        "Sistemas de protección avanzados para mantener tus creaciones seguras",
                      icon: "🛡️",
                    },
                  ].map((feature, index) => (
                    <motion.div
